  ...
  <div class="chart" id="chart">
    <div class="left">
      ...
      <el-row :gutter="20">
        <el-col :span="4" v-for="(item,index) in navArray" :key="index">
          <div class="chart-nav" @click="changeStatisticalCharts(index)">
    ...
    <div class="right">
      <div class="chart-item">
        ...
        <div class="chart-item-info" v-for="(item,index) in 4" :key="index">
          <div>
            <div class="chart-item-num">237</div>
            <div class="chart-item-title">待审核精选文章</div>
          </div>
          <div>
            <div class="chart-item-num">237</div>
            <div class="chart-item-title">待审核绑定的家庭树</div>
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    createChart(myChartData) {
      this.$echarts.registerTheme("walden", obj);
      ...
      // let myChartOption = chart.getMyChartOption(myChartData);
      // let chartMiddleOption = chart.getChartMiddleOption(myChartData);
      let myChartOption = {};
  ...
  async mounted() {
    ...
    let mapRes = await api.Home.summaryStatistics({
      token: localStorage.getItem("token")
    });
